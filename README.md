...
| `enableLegs`          | `Boolean` | `false`    | When true, enables the fetching of route legs and triggers the onLegs callback.                                                                                                                                                                                                                                                                                                                                                                                               |     |
### Types
...
| `onLegs`          | `{ distanceMeters: number; duration: string }[]` | Callback called with route legs if enabled.                                   |
